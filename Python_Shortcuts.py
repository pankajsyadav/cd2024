...
#
# F5
# Execute active script. Executes code or a script, depending on whether a code is highlighted. If nothing is
# highlighted, it executes the active script in the Python Editor work area.
#
# Ctrl+=
